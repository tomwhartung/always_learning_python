...
class QuizForm( forms.Form ):
   ...
   question_04 = forms.ChoiceField( widget=forms.RadioSelect, label=label_04, choices=choices_04 )

   label_05 = get_label( 5, quiz_dictionary[4] )
   choices_05 = get_choices( quiz_dictionary[4] )
   question_05 = forms.ChoiceField( widget=forms.RadioSelect, label=label_05, choices=choices_05 )

   label_06 = get_label( 6, quiz_dictionary[5] )
   choices_06 = get_choices( quiz_dictionary[5] )
   question_06 = forms.ChoiceField( widget=forms.RadioSelect, label=label_06, choices=choices_06 )

   label_07 = get_label( 7, quiz_dictionary[6] )
   choices_07 = get_choices( quiz_dictionary[6] )
   question_07 = forms.ChoiceField( widget=forms.RadioSelect, label=label_07, choices=choices_07 )

   label_08 = get_label( 8, quiz_dictionary[7] )
   choices_08 = get_choices( quiz_dictionary[7] )
   question_08 = forms.ChoiceField( widget=forms.RadioSelect, label=label_08, choices=choices_08 )

   label_09 = get_label( 9, quiz_dictionary[8] )
   choices_09 = get_choices( quiz_dictionary[8] )
   question_09 = forms.ChoiceField( widget=forms.RadioSelect, label=label_09, choices=choices_09 )

   label_10 = get_label( 10, quiz_dictionary[9] )
   choices_10 = get_choices( quiz_dictionary[9] )
   question_10 = forms.ChoiceField( widget=forms.RadioSelect, label=label_10, choices=choices_10 )

   label_11 = get_label( 11, quiz_dictionary[10] )
   choices_11 = get_choices( quiz_dictionary[10] )
   question_11 = forms.ChoiceField( widget=forms.RadioSelect, label=label_11, choices=choices_11 )

   label_12 = get_label( 12, quiz_dictionary[11] )
   choices_12 = get_choices( quiz_dictionary[11] )
   question_12 = forms.ChoiceField( widget=forms.RadioSelect, label=label_12, choices=choices_12 )

   label_13 = get_label( 13, quiz_dictionary[12] )
   choices_13 = get_choices( quiz_dictionary[12] )
   question_13 = forms.ChoiceField( widget=forms.RadioSelect, label=label_13, choices=choices_13 )

   label_14 = get_label( 14, quiz_dictionary[13] )
   choices_14 = get_choices( quiz_dictionary[13] )
   question_14 = forms.ChoiceField( widget=forms.RadioSelect, label=label_14, choices=choices_14 )

   label_15 = get_label( 15, quiz_dictionary[14] )
   choices_15 = get_choices( quiz_dictionary[14] )
   question_15 = forms.ChoiceField( widget=forms.RadioSelect, label=label_15, choices=choices_15 )

   label_16 = get_label( 16, quiz_dictionary[15] )
   choices_16 = get_choices( quiz_dictionary[15] )
   question_16 = forms.ChoiceField( widget=forms.RadioSelect, label=label_16, choices=choices_16 )

   label_17 = get_label( 17, quiz_dictionary[16] )
   choices_17 = get_choices( quiz_dictionary[16] )
   question_17 = forms.ChoiceField( widget=forms.RadioSelect, label=label_17, choices=choices_17 )

   label_18 = get_label( 18, quiz_dictionary[17] )
   choices_18 = get_choices( quiz_dictionary[17] )
   question_18 = forms.ChoiceField( widget=forms.RadioSelect, label=label_18, choices=choices_18 )

   label_19 = get_label( 19, quiz_dictionary[18] )
   choices_19 = get_choices( quiz_dictionary[18] )
   question_19 = forms.ChoiceField( widget=forms.RadioSelect, label=label_19, choices=choices_19 )

   label_20 = get_label( 20, quiz_dictionary[19] )
   choices_20 = get_choices( quiz_dictionary[19] )
   question_20 = forms.ChoiceField( widget=forms.RadioSelect, label=label_20, choices=choices_20 )

   label_21 = get_label( 21, quiz_dictionary[20] )
   choices_21 = get_choices( quiz_dictionary[20] )
   question_21 = forms.ChoiceField( widget=forms.RadioSelect, label=label_21, choices=choices_21 )

   label_22 = get_label( 22, quiz_dictionary[21] )
   choices_22 = get_choices( quiz_dictionary[21] )
   question_22 = forms.ChoiceField( widget=forms.RadioSelect, label=label_22, choices=choices_22 )

   label_23 = get_label( 23, quiz_dictionary[22] )
   choices_23 = get_choices( quiz_dictionary[22] )
   question_23 = forms.ChoiceField( widget=forms.RadioSelect, label=label_23, choices=choices_23 )

   label_24 = get_label( 24, quiz_dictionary[23] )
   choices_24 = get_choices( quiz_dictionary[23] )
   question_24 = forms.ChoiceField( widget=forms.RadioSelect, label=label_24, choices=choices_24 )

   label_25 = get_label( 25, quiz_dictionary[24] )
   choices_25 = get_choices( quiz_dictionary[24] )
   question_25 = forms.ChoiceField( widget=forms.RadioSelect, label=label_25, choices=choices_25 )

   label_26 = get_label( 26, quiz_dictionary[25] )
   choices_26 = get_choices( quiz_dictionary[25] )
   question_26 = forms.ChoiceField( widget=forms.RadioSelect, label=label_26, choices=choices_26 )

   label_27 = get_label( 27, quiz_dictionary[26] )
   choices_27 = get_choices( quiz_dictionary[26] )
   question_27 = forms.ChoiceField( widget=forms.RadioSelect, label=label_27, choices=choices_27 )

   label_28 = get_label( 28, quiz_dictionary[27] )
   choices_28 = get_choices( quiz_dictionary[27] )
   question_28 = forms.ChoiceField( widget=forms.RadioSelect, label=label_28, choices=choices_28 )

   label_29 = get_label( 29, quiz_dictionary[28] )
   choices_29 = get_choices( quiz_dictionary[28] )
   question_29 = forms.ChoiceField( widget=forms.RadioSelect, label=label_29, choices=choices_29 )

   label_30 = get_label( 30, quiz_dictionary[29] )
   choices_30 = get_choices( quiz_dictionary[29] )
   question_30 = forms.ChoiceField( widget=forms.RadioSelect, label=label_30, choices=choices_30 )

   label_31 = get_label( 31, quiz_dictionary[30] )
   choices_31 = get_choices( quiz_dictionary[30] )
   question_31 = forms.ChoiceField( widget=forms.RadioSelect, label=label_31, choices=choices_31 )

   label_32 = get_label( 32, quiz_dictionary[31] )
   choices_32 = get_choices( quiz_dictionary[31] )
   question_32 = forms.ChoiceField( widget=forms.RadioSelect, label=label_32, choices=choices_32 )

   label_33 = get_label( 33, quiz_dictionary[32] )
   choices_33 = get_choices( quiz_dictionary[32] )
   question_33 = forms.ChoiceField( widget=forms.RadioSelect, label=label_33, choices=choices_33 )

   label_34 = get_label( 34, quiz_dictionary[33] )
   choices_34 = get_choices( quiz_dictionary[33] )
   question_34 = forms.ChoiceField( widget=forms.RadioSelect, label=label_34, choices=choices_34 )

   label_35 = get_label( 35, quiz_dictionary[34] )
   choices_35 = get_choices( quiz_dictionary[34] )
   question_35 = forms.ChoiceField( widget=forms.RadioSelect, label=label_35, choices=choices_35 )

   label_36 = get_label( 36, quiz_dictionary[35] )
   choices_36 = get_choices( quiz_dictionary[35] )
   question_36 = forms.ChoiceField( widget=forms.RadioSelect, label=label_36, choices=choices_36 )

   label_37 = get_label( 37, quiz_dictionary[36] )
   choices_37 = get_choices( quiz_dictionary[36] )
   question_37 = forms.ChoiceField( widget=forms.RadioSelect, label=label_37, choices=choices_37 )

   label_38 = get_label( 38, quiz_dictionary[37] )
   choices_38 = get_choices( quiz_dictionary[37] )
   question_38 = forms.ChoiceField( widget=forms.RadioSelect, label=label_38, choices=choices_38 )

   label_39 = get_label( 39, quiz_dictionary[38] )
   choices_39 = get_choices( quiz_dictionary[38] )
   question_39 = forms.ChoiceField( widget=forms.RadioSelect, label=label_39, choices=choices_39 )

   label_40 = get_label( 40, quiz_dictionary[39] )
   choices_40 = get_choices( quiz_dictionary[39] )
   question_40 = forms.ChoiceField( widget=forms.RadioSelect, label=label_40, choices=choices_40 )

   label_41 = get_label( 41, quiz_dictionary[40] )
   choices_41 = get_choices( quiz_dictionary[40] )
   question_41 = forms.ChoiceField( widget=forms.RadioSelect, label=label_41, choices=choices_41 )

   label_42 = get_label( 42, quiz_dictionary[41] )
   choices_42 = get_choices( quiz_dictionary[41] )
   question_42 = forms.ChoiceField( widget=forms.RadioSelect, label=label_42, choices=choices_42 )

   label_43 = get_label( 43, quiz_dictionary[42] )
   choices_43 = get_choices( quiz_dictionary[42] )
   question_43 = forms.ChoiceField( widget=forms.RadioSelect, label=label_43, choices=choices_43 )

   label_44 = get_label( 44, quiz_dictionary[43] )
   choices_44 = get_choices( quiz_dictionary[43] )
   question_44 = forms.ChoiceField( widget=forms.RadioSelect, label=label_44, choices=choices_44 )

   label_45 = get_label( 45, quiz_dictionary[44] )
   choices_45 = get_choices( quiz_dictionary[44] )
   question_45 = forms.ChoiceField( widget=forms.RadioSelect, label=label_45, choices=choices_45 )

   label_46 = get_label( 46, quiz_dictionary[45] )
   choices_46 = get_choices( quiz_dictionary[45] )
   question_46 = forms.ChoiceField( widget=forms.RadioSelect, label=label_46, choices=choices_46 )

   label_47 = get_label( 47, quiz_dictionary[46] )
   choices_47 = get_choices( quiz_dictionary[46] )
   question_47 = forms.ChoiceField( widget=forms.RadioSelect, label=label_47, choices=choices_47 )

   label_48 = get_label( 48, quiz_dictionary[47] )
   choices_48 = get_choices( quiz_dictionary[47] )
   question_48 = forms.ChoiceField( widget=forms.RadioSelect, label=label_48, choices=choices_48 )

   label_49 = get_label( 49, quiz_dictionary[48] )
   choices_49 = get_choices( quiz_dictionary[48] )
   question_49 = forms.ChoiceField( widget=forms.RadioSelect, label=label_49, choices=choices_49 )

   label_50 = get_label( 50, quiz_dictionary[49] )
   choices_50 = get_choices( quiz_dictionary[49] )
   question_50 = forms.ChoiceField( widget=forms.RadioSelect, label=label_50, choices=choices_50 )

   label_51 = get_label( 51, quiz_dictionary[50] )
   choices_51 = get_choices( quiz_dictionary[50] )
   question_51 = forms.ChoiceField( widget=forms.RadioSelect, label=label_51, choices=choices_51 )

   label_52 = get_label( 52, quiz_dictionary[51] )
   choices_52 = get_choices( quiz_dictionary[51] )
   question_52 = forms.ChoiceField( widget=forms.RadioSelect, label=label_52, choices=choices_52 )

   label_53 = get_label( 53, quiz_dictionary[52] )
   choices_53 = get_choices( quiz_dictionary[52] )
   question_53 = forms.ChoiceField( widget=forms.RadioSelect, label=label_53, choices=choices_53 )

   label_54 = get_label( 54, quiz_dictionary[53] )
   choices_54 = get_choices( quiz_dictionary[53] )
   question_54 = forms.ChoiceField( widget=forms.RadioSelect, label=label_54, choices=choices_54 )

   label_55 = get_label( 55, quiz_dictionary[54] )
   choices_55 = get_choices( quiz_dictionary[54] )
   question_55 = forms.ChoiceField( widget=forms.RadioSelect, label=label_55, choices=choices_55 )

   label_56 = get_label( 56, quiz_dictionary[55] )
   choices_56 = get_choices( quiz_dictionary[55] )
   question_56 = forms.ChoiceField( widget=forms.RadioSelect, label=label_56, choices=choices_56 )

   label_57 = get_label( 57, quiz_dictionary[56] )
   choices_57 = get_choices( quiz_dictionary[56] )
   question_57 = forms.ChoiceField( widget=forms.RadioSelect, label=label_57, choices=choices_57 )

   label_58 = get_label( 58, quiz_dictionary[57] )
   choices_58 = get_choices( quiz_dictionary[57] )
   question_58 = forms.ChoiceField( widget=forms.RadioSelect, label=label_58, choices=choices_58 )

   label_59 = get_label( 59, quiz_dictionary[58] )
   choices_59 = get_choices( quiz_dictionary[58] )
   question_59 = forms.ChoiceField( widget=forms.RadioSelect, label=label_59, choices=choices_59 )

   label_60 = get_label( 60, quiz_dictionary[59] )
   choices_60 = get_choices( quiz_dictionary[59] )
   question_60 = forms.ChoiceField( widget=forms.RadioSelect, label=label_60, choices=choices_60 )

   label_61 = get_label( 61, quiz_dictionary[60] )
   choices_61 = get_choices( quiz_dictionary[60] )
   question_61 = forms.ChoiceField( widget=forms.RadioSelect, label=label_61, choices=choices_61 )

   label_62 = get_label( 62, quiz_dictionary[61] )
   choices_62 = get_choices( quiz_dictionary[61] )
   question_62 = forms.ChoiceField( widget=forms.RadioSelect, label=label_62, choices=choices_62 )

   label_63 = get_label( 63, quiz_dictionary[62] )
   choices_63 = get_choices( quiz_dictionary[62] )
   question_63 = forms.ChoiceField( widget=forms.RadioSelect, label=label_63, choices=choices_63 )

   label_64 = get_label( 64, quiz_dictionary[63] )
   choices_64 = get_choices( quiz_dictionary[63] )
   question_64 = forms.ChoiceField( widget=forms.RadioSelect, label=label_64, choices=choices_64 )

   label_65 = get_label( 65, quiz_dictionary[64] )
   choices_65 = get_choices( quiz_dictionary[64] )
   question_65 = forms.ChoiceField( widget=forms.RadioSelect, label=label_65, choices=choices_65 )

   label_66 = get_label( 66, quiz_dictionary[65] )
   choices_66 = get_choices( quiz_dictionary[65] )
   question_66 = forms.ChoiceField( widget=forms.RadioSelect, label=label_66, choices=choices_66 )

   label_67 = get_label( 67, quiz_dictionary[66] )
   choices_67 = get_choices( quiz_dictionary[66] )
   question_67 = forms.ChoiceField( widget=forms.RadioSelect, label=label_67, choices=choices_67 )

   label_68 = get_label( 68, quiz_dictionary[67] )
   choices_68 = get_choices( quiz_dictionary[67] )
   question_68 = forms.ChoiceField( widget=forms.RadioSelect, label=label_68, choices=choices_68 )

   label_69 = get_label( 69, quiz_dictionary[68] )
   choices_69 = get_choices( quiz_dictionary[68] )
   question_69 = forms.ChoiceField( widget=forms.RadioSelect, label=label_69, choices=choices_69 )

   label_70 = get_label( 70, quiz_dictionary[69] )
   choices_70 = get_choices( quiz_dictionary[69] )
   question_70 = forms.ChoiceField( widget=forms.RadioSelect, label=label_70, choices=choices_70 )
