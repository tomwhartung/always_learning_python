...
Taking copious notes of how we set this up, so we can do it more quickly when it's time to do it "for realsies."

### Step (1) Starting with startproject:
